...
from mobio.libs.validator import Validator, HttpValidator, VALIDATION_RESULT, Length, \
Required, InstanceOf, In, Password, Pattern
...
class UserControllers():
    ...
    def validate_add_user(self, input_data):
        pass

    def add_user(self):
        body_data = request.get_json()
        self.validate_add_user(body_data)
        users = {
